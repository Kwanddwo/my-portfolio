export default function RiskMatrix() {
  ...
  <text x="400" y="30" className="title" text-anchor="middle">Risk Matrix (5x5) - Workshop Project</text>
  
  <text x="30" y="300" className="axis-label" text-anchor="middle" transform="rotate(-90 30 300)">IMPACT</text>
  
  <text x="400" y="670" className="axis-label" text-anchor="middle">PROBABILITY</text>
  ...
  <text x="75" y="135" className="axis-label" text-anchor="end">5</text>
  <text x="75" y="235" className="axis-label" text-anchor="end">4</text>
  <text x="75" y="335" className="axis-label" text-anchor="end">3</text>
  <text x="75" y="435" className="axis-label" text-anchor="end">2</text>
  <text x="75" y="535" className="axis-label" text-anchor="end">1</text>
  
  <text x="160" y="605" className="axis-label" text-anchor="middle">1</text>
  <text x="280" y="605" className="axis-label" text-anchor="middle">2</text>
  <text x="400" y="605" className="axis-label" text-anchor="middle">3</text>
  <text x="520" y="605" className="axis-label" text-anchor="middle">4</text>
  <text x="640" y="605" className="axis-label" text-anchor="middle">5</text>
  
  <text x="400" y="125" className="cell-text">Instructor</text>
  <text x="400" y="140" className="cell-text">Absence</text>
  <text x="400" y="155" className="cell-text">(15)</text>
  
  <text x="400" y="225" className="cell-text">Low</text>
  <text x="400" y="240" className="cell-text">Attendance</text>
  <text x="400" y="255" className="cell-text">(12)</text>
  
  <text x="400" y="310" className="cell-text">Software</text>
  <text x="400" y="325" className="cell-text">Malfunction (9)</text>
  
  <text x="400" y="345" className="cell-text">Schedule</text>
  <text x="400" y="360" className="cell-text">Conflicts (9)</text>
  
  <text x="520" y="420" className="cell-text">Varying</text>
  <text x="520" y="435" className="cell-text">Skills</text>
  <text x="520" y="450" className="cell-text">(8)</text>
  
  <text x="160" y="125" className="cell-text">Power</text>
  <text x="160" y="140" className="cell-text">Outages</text>
  <text x="160" y="155" className="cell-text">(5)</text>
  
  <text x="160" y="215" className="cell-text">Room</text>
  <text x="160" y="230" className="cell-text">Unavailable (4)</text>
  
  <text x="160" y="250" className="cell-text">Extreme</text>
  <text x="160" y="265" className="cell-text">Weather (4)</text>
</svg>
  );
}
